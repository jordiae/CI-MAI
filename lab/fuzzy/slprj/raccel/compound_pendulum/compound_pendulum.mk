...
MODEL                  = compound_pendulum
MODULES                = rt_logging.c compound_pendulum.c compound_pendulum_capi.c compound_pendulum_data.c compound_pendulum_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c
MAKEFILE               = compound_pendulum.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2018b
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2018b
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2018b\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/nhikia/Documents/AI/CI/CI-MAI/lab/fuzzy
...
COMPUTER               = GLNXA64
BUILDARGS              =  MODELLIB=compound_pendulumlib.a RSIM_SOLVER_SELECTION=2 PCMATLABROOT="/usr/local/MATLAB/R2018b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 MODELREF_TARGET_TYPE=NONE ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DEXT_MODE -DON_TARGET_WAIT_FOR_START=0"
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/compound_pendulum \
